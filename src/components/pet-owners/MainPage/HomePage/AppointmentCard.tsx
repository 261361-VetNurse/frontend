        ...
        <CardContainer onClick={onClick}>
            ...
            <div className="name-location">
                ...
                <div className="data-row">
                    <Image className="data-icon" src="/location.svg" alt="location" />
                    <span className="data-text">{datas.location}</span>
                </div>
                <div className="data-row">
                    <Image className="data-icon" src="/calendar.svg" alt="calendar" />
                ...
                <div className="data-row">
                    <Image className="data-icon" src="/clock.svg" alt="time" />
